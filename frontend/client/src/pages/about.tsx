    ...
    <div className="bg-surface dark:bg-slate-950 font-body text-on-surface selection:bg-primary-fixed-dim selection:text-on-primary-fixed min-h-screen flex flex-col overflow-x-hidden">
      ...
      <main className="pt-32 pb-24 flex-grow">
        ...
        <section className="max-w-4xl mx-auto px-8 mb-16 lg:mb-24">
          <div className="bg-surface-container-lowest dark:bg-slate-900 border border-outline-variant/20 rounded-3xl p-8 md:p-12 shadow-xl text-center">
            <h2 className="text-2xl md:text-3xl font-bold font-headline text-primary-container dark:text-blue-50 mb-3">
              Want to Reach Out?
            </h2>
            <p className="text-on-surface-variant dark:text-slate-400 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
              Got feedback, or want to talk about what BulkReferences could do for your team? Reach out through our{" "}
              <Link
                href="/contact"
                className="font-semibold text-primary-container underline underline-offset-4 transition-colors hover:text-[#003366] dark:text-blue-300 dark:hover:text-blue-200"
              >
                Contact page
              </Link>{" "}
