      ...
      <div className="max-w-screen-2xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col gap-2">
          ...
          <p className="font-body text-xs text-slate-500 dark:text-slate-400">
            © {new Date().getFullYear()} BulkReferences. Precision in Every
            Reference.
          </p>
        </div>
        <div className="flex gap-8">
          <Link
            href="/support"
            className="font-body text-xs text-slate-500 dark:text-slate-400 hover:text-primary-container dark:hover:text-blue-200 transition-colors opacity-80 hover:opacity-100 duration-300"
          >
            Support
          </Link>
          <Link
