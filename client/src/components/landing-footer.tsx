...
export function LandingFooter() {
  return (
    <footer className="bg-white dark:bg-slate-950 w-full py-12 border-t border-slate-100 dark:border-slate-800/20 relative z-10 transition-colors">
      <div className="max-w-screen-2xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex flex-col gap-2">
          <span className="font-headline italic text-primary-container dark:text-blue-50 text-xl font-bold transition-colors">BulkReferences</span>
