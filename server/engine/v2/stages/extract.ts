      ...
      const runCitation = async (citation: CanonicalCitation, citationIndex: number) => {
        ...
        let nextCitation: CanonicalCitation = {
          ...
          extraction: {
            ...
            llmFallbackReusedFromCluster: result.llmFallbackReusedFromCluster,
            llmFallbackSkippedForTruth: result.llmFallbackSkippedForTruth,
            llmFallbackVerificationNeeded: result.llmFallbackVerificationNeeded,
            llmFallbackCacheKey: result.llmFallbackCacheKey,
            llmFallbackClusterKey: result.llmFallbackClusterKey,
            llmFallbackQueuePriority: result.llmFallbackQueuePriority,
            llmFallbackAttemptErrorType: result.llmFallbackAttemptErrorType,
            ...
            llmFallbackNoOpAccepted: result.llmFallbackNoOpAccepted,
            rejectedCandidates: [
