...
| --- | --- | --- | --- | --- | --- |
| title | 6864 | 6850 | 0.998 | false | false |
| url | 6864 | 6824 | 0.9942 | false | false |
| year | 6864 | 6814 | 0.9927 | false | false |
| journal/venue | 6072 | 6001 | 0.9883 | false | false |
| doi | 5280 | 5074 | 0.961 | false | false |
| authors | 4686 | 4681 | 0.9989 | false | false |
| firstAuthor | 4686 | 4681 | 0.9989 | false | false |
| publisher | 2298 | 2212 | 0.9626 | false | false |
| pages | 1602 | 1593 | 0.9944 | false | false |
| institution | 1560 | 1524 | 0.9769 | false | false |
| isbn | 1482 | 1364 | 0.9204 | false | true |
| bookTitle | 792 | 770 | 0.9722 | false | false |
| patent | 792 | 792 | 1 | false | false |
| siteName | 792 | 749 | 0.9457 | false | true |
| issn | 774 | 739 | 0.9548 | false | false |
| conferenceTitle | 762 | 742 | 0.9738 | false | false |
| volume | 750 | 735 | 0.98 | false | false |
| issue | 744 | 724 | 0.9731 | false | false |
| repository | 738 | 712 | 0.9648 | false | false |
| thesisType | 738 | 729 | 0.9878 | false | false |
...
| article-journal-35882be2624f3136:apa7:clean | authors, title, year, doi, url, journal/venue, volume, issue, pages | authors, doi, firstAuthor, issn, issue, journal/venue, pages, title, url, volume, year | authors, conferenceTitle, doi, firstAuthor, journal/venue, pages, publisher, title, url, year | volume, issue |
| article-journal-35882be2624f3136:harvard-ctr:clean | authors, title, year, doi, url, journal/venue, volume, issue, pages | authors, doi, firstAuthor, issn, issue, journal/venue, pages, title, url, volume, year | authors, conferenceTitle, doi, firstAuthor, journal/venue, pages, publisher, title, url, year | volume, issue |
| article-journal-35882be2624f3136:chicago-notes-bib:clean | authors, title, year, doi, url, journal/venue, volume, issue, pages | authors, doi, firstAuthor, issn, issue, journal/venue, pages, title, url, volume, year | authors, conferenceTitle, doi, firstAuthor, journal/venue, pages, publisher, title, url, year | volume, issue |
| article-journal-35882be2624f3136:vancouver:clean | authors, title, year, doi, url, journal/venue, volume, issue, pages | authors, doi, firstAuthor, issn, issue, journal/venue, pages, title, url, volume, year | authors, conferenceTitle, doi, firstAuthor, journal/venue, pages, publisher, title, url, year | volume, issue |
| article-journal-3a70c59dce3aef0a:chicago-notes-bib:noisy | year, doi, url, volume, issue, pages | authors, doi, firstAuthor, issn, issue, journal/venue, pages, title, url, volume, year | authors, conferenceTitle, doi, firstAuthor, journal/venue, pages, title, url, year | volume, issue |

## Clean Structure Breakdown

| Structure | Compared | Soft Instance F1 | Macro Soft F1 |
| --- | --- | --- | --- |
| structured | 6000 | 0.9175 | 0.9866 |
| unstructured | 0 | 0 | 0 |
...
| --- | --- | --- | --- | --- | --- | --- |
| isbn | 0.9072 | 46 | 10 | 1046 | 168 | 46 |
| authors | 0.9541 | 0 | 0 | 3760 | 362 | 0 |
| title | 0.9866 | 0 | 0 | 5841 | 159 | 0 |
| publisher | 0.987 | 23 | 2783 | 1929 | 28 | 23 |
| institution | 0.9878 | 18 | 540 | 1376 | 16 | 18 |
| issn | 0.9882 | 16 | 40 | 668 | 0 | 16 |
| bookTitle | 0.9917 | 10 | 24 | 655 | 1 | 10 |
| conferenceTitle | 0.9924 | 3 | 711 | 656 | 7 | 3 |
| journal/venue | 0.9944 | 1 | 0 | 5275 | 58 | 1 |
| repository | 0.9955 | 6 | 0 | 660 | 0 | 6 |
| patent | 0.9992 | 0 | 0 | 665 | 1 | 0 |
| year | 0.9998 | 0 | 0 | 5998 | 2 | 0 |
| url | 0.9999 | 0 | 0 | 5999 | 1 | 0 |
| siteName | 1 | 0 | 672 | 666 | 0 | 0 |
| doi | 1 | 0 | 0 | 4668 | 0 | 0 |
...
| --- | --- | --- | --- |
| chicago-notes-bib | conference-paper | 111 | 0.7838 |
| harvard-ctr | article-journal | 115 | 0.8348 |
| chicago-notes-bib | book-chapter | 111 | 0.8378 |
| ieee | book | 108 | 0.8519 |
| chicago-notes-bib | article-journal | 115 | 0.8696 |
| chicago-notes-bib | preprint | 111 | 0.8739 |
| apa7 | preprint | 111 | 0.8829 |
| vancouver | book-chapter | 111 | 0.8919 |
| chicago-notes-bib | book | 108 | 0.8981 |
...
| thesis-384ffb193c34a59f:mla9:clean | thesis | thesis | uncertain_split_block, input_style_uncertain, missing_preferred_fields | Melo Franco, Eliane. Estudo “in Vitro” Do Bochecho Pre-Escovação Plax Na Reatividade Do Fluor Com Esmalte Dental Humano. 2021, https://doi.org/10.47749/t/unicamp.1992.51275. Universidade Estadual de Campinas, Dissertation. |
...
| webpage-36eb4b0ea5a8c520:mla9:clean | webpage | webpage | uncertain_split_block, input_style_uncertain, missing_preferred_fields, render_style_fallback | React Team. “State: A Component’s Memory.” React, React Team, 2024, https://react.dev/learn/state-a-components-memory. |

### vancouver -> unknown

| Variant | Type | Detected Type | Warnings | Citation |
| --- | --- | --- | --- | --- |
| article-journal-678ddffaa1e4eded:vancouver:clean | article-journal | article-journal | uncertain_split_block, input_style_uncertain, missing_preferred_fields | [1]Зябриков ВВ. Систематизация ценностей деловой культуры России. Creative Economy 2015;9:1191. https://doi.org/10.18334/ce.9.9.1923. |
| article-journal-90b31f8da8ebd833:vancouver:clean | article-journal | article-journal | uncertain_split_block, input_style_uncertain, missing_preferred_fields | [1]Rino R, Aryadi M, Abidin Z. STRATEGI PENGELOLAAN PROGRAM PERHUTANAN SOSIAL DI KESATUAN PENGELOLAAN HUTAN LINDUNG SENGAYAM. Jurnal Hutan Tropis 2025;13:12. https://doi.org/10.20527/jht.v13i1.22176. |
...
| webpage-36eb4b0ea5a8c520:vancouver:clean | webpage | webpage | uncertain_split_block, input_style_uncertain, missing_preferred_fields | [1]React Team. State: A Component’s Memory. React 2024. https://react.dev/learn/state-a-components-memory. |
...
| thesis-190e82686045c380:vancouver:clean | thesis | thesis | uncertain_split_block, input_style_uncertain, missing_preferred_fields | [1]Silva NF de. Body weight prediction of crossbred beef cattle through the image processing and machine learning algorithms. Dissertation. Pro-Reitoria de Pesquisa e Pos-Graduacai - UFV, 2023. https://doi.org/10.47328/ufvbbt.2022.729. |
| thesis-3fc1fec9b1d96054:vancouver:clean | thesis | thesis | uncertain_split_block, input_style_uncertain, missing_preferred_fields | [1]GONCALVES BEZERRA N. PLANEJAMENTO E GESTÃO DE CARREIRA: UM ESTUDO SOBRE A CARREIRA DO PROFISSIONAL DE XADREZ. Dissertation. Faculdades Catolicas, 2023. https://doi.org/10.17771/pucrio.acad.63352. |
| thesis-51459f4646813bfe:vancouver:clean | thesis | thesis | uncertain_split_block, input_style_uncertain, missing_preferred_fields | [1]Casanova E. Síntese de fala aplicada à geração de conjunto de dados para reconhecimento automático de fala. Dissertation. Universidade de Sao Paulo, Agencia USP de Gestao da Informacao Academica (AGUIA), 2022. https://doi.org/10.11606/t.55.2022.tde-02092022-142539. |

### mla9 -> harvard-ctr

| Variant | Type | Detected Type | Warnings | Citation |
| --- | --- | --- | --- | --- |
| thesis-73dce4c3787011a9:mla9:clean | thesis | thesis | uncertain_split_block, missing_preferred_fields | Correa Coelho, Ricardo. A Linguagem Da Campanha Para a Prefeitura de São Paulo de 1985. 2021, https://doi.org/10.47749/t/unicamp.1991.36978. Universidade Estadual de Campinas, Dissertation. |
...
| article-journal | conference-paper | 9 |
| article-journal | preprint | 6 |
| preprint | book | 5 |
| conference-paper | article-journal | 3 |
...
| --- | --- | --- |
| patent | siteName | 666 |
| webpage | publisher | 660 |
| preprint | publisher | 657 |
| patent | conferenceTitle | 647 |
| patent | publisher | 553 |
| article-journal | publisher | 482 |
| report | publisher | 406 |
| preprint | institution | 202 |
| conference-paper | institution | 192 |
| preprint | journal | 90 |
| book-chapter | institution | 60 |
| article-journal | institution | 56 |
| preprint | conferenceTitle | 36 |
| conference-paper | issn | 33 |
| book-chapter | journal | 30 |
| book | institution | 30 |
| conference-paper | volume | 26 |
| thesis | publisher | 25 |
| report | journal | 24 |
| article-journal | conferenceTitle | 22 |
...
| article-journal-35882be2624f3136:apa7:clean | ANALISIS BEBAN KERJA PADA PT. BPR SUBANG GEMI NASTITI (PERSERODA) KANTOR PUSAT OPERASIONAL DI KOTA SUBANG | ANALISIS BEBAN KERJA PADA PT. | ANALISIS BEBAN KERJA PADA PT. | conference-paper | apa7 | truncated_value |
| article-journal-35882be2624f3136:chicago-notes-bib:clean | ANALISIS BEBAN KERJA PADA PT. BPR SUBANG GEMI NASTITI (PERSERODA) KANTOR PUSAT OPERASIONAL DI KOTA SUBANG | ANALISIS BEBAN KERJA PADA PT. | ANALISIS BEBAN KERJA PADA PT. | conference-paper | chicago-notes-bib | truncated_value |
...
| Variant | Expected | Predicted | Raw Predicted | Detected Type | Detected Style | Reason |
| --- | --- | --- | --- | --- | --- | --- |
| conference-paper-34139bcc4a05cfa1:ieee:clean | 2024 International Conference on Communication, Control, and Intelligent Systems (CCIS) |  | International Conference on Communication, Control, and Intelligent Systems (CCIS) | article-journal | ieee | wrong_type_field |
| conference-paper-73e657900253be83:apa7:clean | AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | conference-paper | apa7 | catastrophic_wrong_content |
| conference-paper-73e657900253be83:chicago-notes-bib:clean | AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | conference-paper | chicago-notes-bib | catastrophic_wrong_content |
| conference-paper-73e657900253be83:harvard-ctr:clean | AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | conference-paper | harvard-ctr | catastrophic_wrong_content |
| conference-paper-73e657900253be83:ieee:clean | AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | 2019, AIAA Scitech 2019 Forum | conference-paper | ieee | catastrophic_wrong_content |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| article-journal-35882be2624f3136:apa7:clean | structured | csl_rendered | apa7 | article-journal | apa7 | conference-paper | title, volume, issue | institution, issn, issue, volume |
| article-journal-35882be2624f3136:chicago-notes-bib:clean | structured | csl_rendered | chicago-notes-bib | article-journal | chicago-notes-bib | conference-paper | title, volume, issue | institution, issn, issue, volume |
| article-journal-35882be2624f3136:harvard-ctr:clean | structured | csl_rendered | harvard-ctr | article-journal | harvard-ctr | conference-paper | title, volume, issue | institution, issn, issue, volume |
| article-journal-35882be2624f3136:vancouver:clean | structured | csl_rendered | vancouver | article-journal | vancouver | conference-paper | title, volume, issue | institution, issn, issue, volume |
...
| book-b9e5bfa7dfe38bdf:chicago-notes-bib:clean | structured | csl_rendered | chicago-notes-bib | book | chicago-notes-bib | book | authors, title |  |
| book-b9e5bfa7dfe38bdf:mla9:clean | structured | csl_rendered | mla9 | book | mla9 | book | authors, title |  |
