...
| journal/venue | 400 | 391 | 0.9775 | false | false |
| title | 400 | 400 | 1 | false | false |
| url | 400 | 396 | 0.99 | false | false |
| year | 400 | 398 | 0.995 | false | false |
| repository | 340 | 333 | 0.9794 | false | false |
| bookTitle | 60 | 54 | 0.9 | true | false |
| isbn | 60 | 45 | 0.75 | true | false |
...
| --- | --- | --- | --- | --- |
| book-chapter-9cf6ab99ace9bad7:apa7:clean | title, year, doi, url, bookTitle, pages, isbn, publisher, journal/venue | authors, bookTitle, doi, firstAuthor, isbn, journal/venue, pages, publisher, title, url, year | authors, doi, firstAuthor, isbn, pages, publisher, title, url, year | bookTitle, journal/venue |
| book-chapter-9cf6ab99ace9bad7:harvard-ctr:clean | title, year, doi, url, bookTitle, pages, isbn, publisher, journal/venue | authors, bookTitle, doi, firstAuthor, isbn, journal/venue, pages, publisher, title, url, year | authors, doi, firstAuthor, isbn, pages, publisher, title, url, year | bookTitle, journal/venue |
| book-chapter-9cf6ab99ace9bad7:chicago-notes-bib:clean | authors, title, year, doi, url, bookTitle, isbn, publisher, journal/venue | authors, bookTitle, doi, firstAuthor, isbn, journal/venue, pages, publisher, title, url, year | authors, doi, firstAuthor, isbn, pages, publisher, title, url, year | bookTitle, journal/venue |
| book-chapter-9cf6ab99ace9bad7:vancouver:clean | title, year, doi, url, bookTitle, isbn, publisher, journal/venue | authors, bookTitle, doi, firstAuthor, isbn, journal/venue, pages, publisher, title, url, year | authors, doi, firstAuthor, isbn, pages, publisher, title, url, year | bookTitle, journal/venue |
| book-chapter-9cf6ab99ace9bad7:ieee:clean | title, year, doi, url, bookTitle, pages, isbn, publisher, journal/venue | authors, bookTitle, doi, firstAuthor, isbn, journal/venue, pages, publisher, title, url, year | authors, doi, firstAuthor, isbn, pages, publisher, title, url, year | bookTitle, journal/venue |
| book-chapter-9cf6ab99ace9bad7:mla9:clean | authors, title, year, doi, url, bookTitle, isbn, publisher, journal/venue | authors, bookTitle, doi, firstAuthor, isbn, journal/venue, pages, publisher, title, url, year | authors, doi, firstAuthor, isbn, pages, publisher, title, url, year | bookTitle, journal/venue |
| preprint-144383a403d1db07:apa7:noisy | title, repository, journal/venue | authors, doi, firstAuthor, journal/venue, repository, title, url, year | authors, firstAuthor, journal/venue, publisher, title, url, year | repository |
...
| preprint-41f44a875a1ce010:apa7:noisy | title, repository, journal/venue | authors, doi, firstAuthor, journal/venue, repository, title, url, year | authors, firstAuthor, journal/venue, publisher, title, url | repository |
...
| isbn | 0.2222 | 6 | 0 | 6 | 36 | 6 |
| bookTitle | 0.9333 | 6 | 6 | 42 | 0 | 6 |
| authors | 0.9492 | 0 | 0 | 327 | 35 | 0 |
| journal/venue | 0.9916 | 6 | 0 | 356 | 0 | 6 |
...
| preprint | journal | 60 |
| conference-paper | bookTitle | 6 |
| conference-paper | institution | 6 |
...
| --- | --- | --- | --- | --- | --- | --- |
| preprint-0c09765f95636878:apa7:clean | Zhu, Changda; Qiu, Xi; Li, yuanming; Zhang, Wei; Yang, Jian; Zhong, Yilong; Deng, Jiuguo; Zhou, Mingyang; Liu, Ning; Yang, Jijun | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | preprint | apa7 | author_initials_only |
| preprint-0c09765f95636878:chicago-notes-bib:clean | Zhu, Changda; Qiu, Xi; Li, yuanming; Zhang, Wei; Yang, Jian; Zhong, Yilong; Deng, Jiuguo; Zhou, Mingyang; Liu, Ning; Yang, Jijun | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | preprint | chicago-notes-bib | author_initials_only |
| preprint-0c09765f95636878:harvard-ctr:clean | Zhu, Changda; Qiu, Xi; Li, yuanming; Zhang, Wei; Yang, Jian; Zhong, Yilong; Deng, Jiuguo; Zhou, Mingyang; Liu, Ning; Yang, Jijun | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | preprint | harvard-ctr | author_initials_only |
| preprint-0c09765f95636878:ieee:clean | Zhu, Changda; Qiu, Xi; Li, yuanming; Zhang, Wei; Yang, Jian; Zhong, Yilong; Deng, Jiuguo; Zhou, Mingyang; Liu, Ning; Yang, Jijun | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | preprint | ieee | author_initials_only |
| preprint-0c09765f95636878:mla9:clean | Zhu, Changda; Qiu, Xi; Li, yuanming; Zhang, Wei; Yang, Jian; Zhong, Yilong; Deng, Jiuguo; Zhou, Mingyang; Liu, Ning; Yang, Jijun | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | Zhu, C; Qiu, X; yuanming, Li; Zhang, W; Yang, J; Zhong, Y | preprint | mla9 | author_initials_only |
...
| Variant | Expected | Predicted | Raw Predicted | Detected Type | Detected Style | Reason |
| --- | --- | --- | --- | --- | --- | --- |
| book-chapter-9cf6ab99ace9bad7:apa7:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  |  | conference-paper | apa7 | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:chicago-notes-bib:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  |  | conference-paper | chicago-notes-bib | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:harvard-ctr:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  |  | conference-paper | harvard-ctr | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:ieee:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  |  | conference-paper | ieee | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:mla9:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  |  | conference-paper | mla9 | wrong_type_field |

### bookTitle

| Variant | Expected | Predicted | Raw Predicted | Detected Type | Detected Style | Reason |
| --- | --- | --- | --- | --- | --- | --- |
| book-chapter-9cf6ab99ace9bad7:apa7:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) | conference-paper | apa7 | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:chicago-notes-bib:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) | conference-paper | chicago-notes-bib | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:harvard-ctr:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) | conference-paper | harvard-ctr | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:ieee:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) | conference-paper | ieee | wrong_type_field |
| book-chapter-9cf6ab99ace9bad7:mla9:clean | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) |  | Proceeding of The 13th International Conference onMalaysia-Indonesia Relations (PAHMI) | conference-paper | mla9 | wrong_type_field |

### isbn

| Variant | Expected | Predicted | Raw Predicted | Detected Type | Detected Style | Reason |
| --- | --- | --- | --- | --- | --- | --- |
| book-chapter-93fba290ca37adff:apa7:clean | 9783658079673 | 9783658079680 | 9783658079680 | book-chapter | apa7 | catastrophic_wrong_content |
| book-chapter-93fba290ca37adff:chicago-notes-bib:clean | 9783658079673 | 9783658079680 | 9783658079680 | book-chapter | chicago-notes-bib | catastrophic_wrong_content |
| book-chapter-93fba290ca37adff:harvard-ctr:clean | 9783658079673 | 9783658079680 | 9783658079680 | book-chapter | harvard-ctr | catastrophic_wrong_content |
| book-chapter-93fba290ca37adff:ieee:clean | 9783658079673 | 9783658079680 | 9783658079680 | book-chapter | ieee | catastrophic_wrong_content |
| book-chapter-93fba290ca37adff:mla9:clean | 9783658079673 | 9783658079680 | 9783658079680 | book-chapter | mla9 | catastrophic_wrong_content |
...
| book-chapter-9cf6ab99ace9bad7:vancouver:clean | structured | csl_rendered | vancouver | book-chapter | vancouver | conference-paper | bookTitle, journal/venue | bookTitle, institution |
...
| preprint-219022281916469e:vancouver:clean | structured | csl_rendered | vancouver | preprint | vancouver | preprint | authors | publisher |
