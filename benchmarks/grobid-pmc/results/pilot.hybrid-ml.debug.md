...
- Semantic Output Hash: sha256:7528f191389f77a1392c8f3f8a6b96da1a200006c3ed90cd7d9febe9109417c2
...
| issn | 162 | 160 | 0.9877 | false | false |
| issue | 162 | 161 | 0.9938 | false | false |
| volume | 162 | 161 | 0.9938 | false | false |
...
| webpage-02d23a55c7f1c255:apa7:noisy | title, year, institution, siteName, url, journal/venue | institution, journal/venue, siteName, title, url, year | authors, firstAuthor, journal/venue, pages, pmid, title, url, year | institution, siteName |
| webpage-02d23a55c7f1c255:harvard-ctr:noisy | title, year, institution, siteName, url, journal/venue | institution, journal/venue, siteName, title, url, year | authors, firstAuthor, institution, journal/venue, title, url, year | siteName |
| webpage-02d23a55c7f1c255:ieee:noisy | title, institution, siteName, url, journal/venue | institution, journal/venue, siteName, title, url, year | authors, firstAuthor, journal/venue, pages, title, url, year | institution, siteName |

## Clean Structure Breakdown

| Structure | Compared | Soft Instance F1 | Macro Soft F1 |
| --- | --- | --- | --- |
| structured | 1200 | 0.9517 | 0.9924 |
| unstructured | 0 | 0 | 0 |
...
- Style Family Accuracy: 0.9825 (1179/1200)
...
| mla9 | book-chapter | 22 | 0.8636 |
| vancouver | article-journal | 23 | 0.8696 |
...
| chicago-notes-bib | preprint | 22 | 0.9091 |
...
| webpage-0904f991c100052e:apa7:clean | webpage | webpage | input_style_uncertain, missing_preferred_fields | The IPv6 VPN Service Destination Option. (2025). RFC Editor. https://www.rfc-editor.org/rfc/rfc9837.html |

### mla9 -> unknown

| Variant | Type | Detected Type | Warnings | Citation |
| --- | --- | --- | --- | --- |
| patent-03eb9c509756f30f:mla9:clean | patent | patent | input_style_uncertain, missing_preferred_fields | Web Page Ranking for Page Query across Public and Private. US20060235842A1, 2006, https://patents.google.com/patent/US20060235842A1/en. |
| webpage-00a35ae549875b24:mla9:clean | webpage | webpage | input_style_uncertain, missing_preferred_fields | “Export of UDP Options Information in IP Flow Information Export (IPFIX).” RFC Editor, 2025, https://www.rfc-editor.org/rfc/rfc9870.html. |
| webpage-06336e77ec7fe31e:mla9:clean | webpage | webpage | uncertain_institution, input_style_uncertain, missing_preferred_fields | “TLS Encrypted Client Hello.” RFC Editor, 2026, https://www.rfc-editor.org/rfc/rfc9849.html. |
| webpage-0904f991c100052e:mla9:clean | webpage | webpage | uncertain_institution, input_style_uncertain, missing_preferred_fields | “The IPv6 VPN Service Destination Option.” RFC Editor, 2025, https://www.rfc-editor.org/rfc/rfc9837.html. |
...
| webpage-27947c124fa1d625:mla9:clean | webpage | webpage | missing_preferred_fields, render_style_fallback | Mozilla Contributors. “Array.Prototype.Map().” MDN Web Docs, Mozilla Contributors, 2024, https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/map. |
...
| article-journal-14841d09ae76e220:chicago-notes-bib:clean | structured | csl_rendered | chicago-notes-bib | article-journal | chicago-notes-bib | article-journal | authors |  |
| article-journal-14841d09ae76e220:mla9:clean | structured | csl_rendered | mla9 | article-journal | mla9 | article-journal | authors |  |
...
| book-chapter-0ae11ce81d7289e2:vancouver:clean | structured | csl_rendered | vancouver | book-chapter | vancouver | book-chapter | publisher | journal |
| book-chapter-10603d9db85098f0:apa7:clean | structured | csl_rendered | apa7 | book-chapter | apa7 | book-chapter | authors |  |
| book-chapter-10603d9db85098f0:chicago-notes-bib:clean | structured | csl_rendered | chicago-notes-bib | book-chapter | chicago-notes-bib | book-chapter | authors |  |
